...
Route::middleware([LoginAdminMiddleware::class, RevalidateBackHistory::class])->group(function (){
    ...
    Route::group(['prefix' => 'users', 'as'=>'users.', 'middleware' => 'check-admin'], function (){
    ...
    Route::group(['prefix' => 'orders', 'as'=>'orders.'], function (){
        ...
        Route::post('reject-order/{order}', [OrderController::class, 'rejectOrder'])->name('reject-order');
    });
    ...
    Route::group(['prefix' => 'statistical', 'as'=>'statistical.'], function (){
        ...
        Route::get('/get-revenue', [StatisticalController::class, 'getRevenue'])->name('revenue')->middleware('check-admin');
    });
...
Route::middleware([LoginCustomerMiddleware::class, RevalidateBackHistory::class])->group(function (){
    ...
    Route::get('cart-detail', [CartController::class, 'cartDetail'])->name('carts.detail');
