                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-5 p-b-30">
                        <div class="p-r-50 p-t-5 p-lr-0-lg">
                            <h4 class="mtext-105 cl2 js-name-detail.blade.php p-b-14">
                                {{$product->name}}
                            </h4>

                            <span class="mtext-106 cl2">
								Giá: {{$product->sale_price}} <span class="ml-3" style="text-decoration: line-through;font-size:12px; opacity: 0.8;">{{$product->old_price}}đ</span>
							</span>
                            ...
                            <div class="p-t-33">
                                ...
                                <div class="flex-w flex-r-m p-b-10">
                                    <div class="size-204 flex-w flex-m respon6-next">
                                        ...
                                        <button class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 js-addcart-detail.blade.php">
                                            Add to cart
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="flex-w flex-m p-l-100 p-t-40 respon7">
                                <div class="flex-m bor9 p-r-10 m-r-11">
                                    <a href="#" class="fs-14 cl3 hov-cl1 trans-04 lh-10 p-lr-5 p-tb-2 js-addwish-detail.blade.php tooltip100" data-tooltip="Add to Wishlist">
